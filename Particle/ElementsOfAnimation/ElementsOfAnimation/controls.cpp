...
glm::vec3 position = glm::vec3(2, 3, 4);
// Initial horizontal angle : toward -Z
float horizontalAngle = 3.14*5/4;
// Initial vertical angle : none
float verticalAngle = -13.3;
...
void computeMatricesFromInputs(const int window_w, const int window_h) {
	...
	ProjectionMatrix = glm::perspective(FoV, (float)window_w / (float)window_h, 0.1f, 100.0f);
	// Camera matrix
