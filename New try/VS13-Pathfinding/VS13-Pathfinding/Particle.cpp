...
m_previousPosition(x, y, z), m_velocity(0, 0, 0), m_force(0, 0, 0), m_bouncing(1), m_lifetime(500000), m_fixed(false)
{
	bi_particle = false;
	...
	//Vertice color
	particle_VBO.push_back(glm::vec3(1.0f, 0, 0));
	//Velocity part
	particle_VBO.push_back(m_currentPosition + m_velocity * 0.2f);
	particle_VBO.push_back(glm::vec3(0, 1.0f, 0));
...
void Particle::draw(GLuint shaderProgramID, glm::vec3 wayp)
{
